module.exports = {
    kibana_log:function(sha, pipeline_id, data) {
        if (data.status == "success" || data.status == "failed" ) {
            ...
            link = "https://e2elogs.openebs.ci/app/kibana#/discover?_g=(refreshInterval:('$$hashKey':'object:188',display:Off,pause:!f,section:0,value:0),time:(from:'"+ started_at +"',mode:absolute,to:'" + finished_at + "'))&_a=(columns:!(_source),filters:!(('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'8d3d6950-ea9c-11e8-8cff-a161f7929609',key:commit_id,negate:!f,params:(query:'" + sha + "',type:phrase),type:phrase,value:'" + sha + "'),query:(match:(commit_id:(query:'" + sha + "',type:phrase)))),('$state':(store:appState),meta:(alias:!n,disabled:!f,index:'8d3d6950-ea9c-11e8-8cff-a161f7929609',key:pipeline_id,negate:!f,params:(query:'"+ pipeline_id + "',type:phrase),type:phrase,value:'"+ pipeline_id + "'),query:(match:(pipeline_id:(query:'"+ pipeline_id + "',type:phrase))))),index:'8d3d6950-ea9c-11e8-8cff-a161f7929609',interval:auto,query:(language:lucene,query:''),sort:!('@timestamp',desc))"
            return link;
        }
        else {
